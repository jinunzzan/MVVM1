...
class DogView: UIView{
    ...
    override init(frame: CGRect){
        ...
        imageView.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.004).isActive = true
        imageView.heightAnchor.constraint(equalTo: self.heightAnchor, multiplier: 0.004).isActive = true
